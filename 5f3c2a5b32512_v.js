(function() {
    var domain = 'a.mgid.com'; var gid = '0'; var tid = '0'; var muidn = ''; var mtuid = '0';
    ...
    var MgSensor = function(params) {
        ...
        var cmHost = "//" + domain.replace(/^[^.]./, 'cm.') + "/sm.js";
        ...
        var updateUtmData = function () {
            ...
            var queryClid = queryParts['mgclid'] || (queryParts['mgclida'] ? queryParts[queryParts['mgclida']] : null);
            if (queryClid) {
